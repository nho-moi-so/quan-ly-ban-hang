            ...
            <div class="col-md-12">
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><b>Quản Lý Danh Mục/Thêm Danh Mục</b></a></li>
                    </ul>
                    <div id="clock"></div>
                </div>
            </div>
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                                <a class="btn btn-add btn-sm" href="qldanhmuc.php" title="Thêm"><i class="fas fa-plus"></i>
                                    Tạo mới danh mục</a>
                            </div>
                        </div>
                    </div>
                ...
                style="padding: 8px; width: 200px; margin-right: 10px;">
                            ...
                            <script>
                                ...
                                let categories = [{
                                        ...
                                        maSanPham: 'SP001',
                                        tenDanhMuc: 'Gia Vị',
                                        moTaDanhMuc: 'Các loại gia vị nấu ăn'
                                    },
                                    {
                                        id: '02',
                                        maDanhMuc: '02',
                                        maSanPham: 'SP002',
                                        tenDanhMuc: 'Bánh,Kẹo',
                                        moTaDanhMuc: 'Các loại bánh kẹo'
                                    },
                                    {
                                        id: '03',
                                        maDanhMuc: '03',
                                        maSanPham: 'SP003',
                                        tenDanhMuc: 'Mì, Phở, Cháo',
                                        moTaDanhMuc: 'Thực phẩm ăn liền'
                                    },
                                    {
                                        id: '04',
                                        maDanhMuc: '04',
                                    ...
                                    },
                                    {
                                        ...
                                        maDanhMuc: '05',
                                        maSanPham: 'SP005',
                                        tenDanhMuc: 'Sữa Đóng Hộp',
                                        moTaDanhMuc: 'Thực phẩm dinh dưỡng'
                                    },
                                    {
                                        id: '06',
                                        maDanhMuc: '06',
                                        maSanPham: 'SP006',
                                        tenDanhMuc: 'Nước Đóng Chai',
                                        moTaDanhMuc: 'Các loại thức uống '
                                    }
                                ];
